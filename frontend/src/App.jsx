          ...
          <div className="modal" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <div className="plan-guide-block warn">
                ...
                <ol>
                  <li>
                    <strong>Вкладка «Воронки»</strong> → выберите воронку amo CRM и воронку Kommo → нажмите
                    «Синхронизировать этапы». Система создаст в Kommo все этапы из воронки Школа/Репетиторство.
                  </li>
                  <li>
              ...
              <div className="plan-guide-block green">
                ...
                <ol>
                  ...
                  <li>
                    <strong>Выберите размер пакета:</strong> 10 / 50 / 100 / 200 / ВСЕ.
